...
Every system, cryptographic protocol, and integration documented across this site is **fully deployed, operational, and active in production**:

| Subsystem | Operational Status | Production Environment |
| :--- | :--- | :--- |
| **Eyewitness Mobile App** | **Live in Production** | Apple App Store (App ID: `6760804538`) |
| **Newsroom Terminal** | **Live in Production** | `https://terminal.extrascoop.app` |
| **Silicon Trust™ Deepfake Engine** | **Live in Production** | Real-time multi-oracle screening & C2PA manifest injection |
| **Base L2 Digital Deeds & Escrow** | **Live in Production** | Base Mainnet & IPFS decentralised storage |
| **Post-Quantum Ephemeral Chat** | **Live in Production** | Active ML-KEM 768 / RSA-OAEP / AES-GCM hybrid E2EE |
| **OmniCommand AI Search** | **Live in Production** | Tier-0 edge in-memory & Tier-1 vector cache |
| **Model Context Protocol (MCP)** | **Live in Production** | `https://api.extrascoop.app/functions/v1/mcp-server` |
| **IPTC Wire & Webhook Exporter** | **Live in Production** | Live IPTC NewsML-G2 XML & HMAC-SHA256 webhooks |
