...
* **Provenance Anchor:** A SHA-256 cryptographic hash combining the unique scoop identifier, the C2PA root manifest, and the purchasing organisation identifier.
...
This on-chain record allows legal and compliance teams to independently verify media acquisition details on the public blockchain without relying on centralised intermediaries.
