...
Extra Scoop incorporates an automated Smart Escrow system to manage financial settlement between newsrooms and eyewitnesses. Escrow ensures that newsrooms receive verified broadcast-grade media with full legal provenance, and that creators receive guaranteed payment the moment licensing terms are accepted.
