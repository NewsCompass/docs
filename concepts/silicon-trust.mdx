...
graph TD
    ...
    E --> F[Provenance Invariance: Raw Purge]
...
To prevent unwatermarked source material from leaking or being scraped without authorization, the platform enforces **Provenance Invariance**:
