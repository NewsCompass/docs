...
* **Deterministic Noise Wipe:** When a chat session reaches its operational timeout or when you sign out, the app overwrites cryptographic memory buffers with cryptographically secure random noise, rendering unauthorized memory extraction impossible.
