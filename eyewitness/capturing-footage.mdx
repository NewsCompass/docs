...
| **Pseudonymous / Blind ID** | A masked cryptographic session ID is displayed. | Maintained in secure escrow identity storage, protecting whistleblower confidentiality. |
