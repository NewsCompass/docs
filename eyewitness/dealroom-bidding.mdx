...
3. The dashboard details the bidding organisation, offer amount in GBP (£), licence type, and the live **expiry countdown timer** (configured by the newsroom between 3 minutes and 1 hour).
